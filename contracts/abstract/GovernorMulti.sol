...
import {IGovernorMulti} from "./IGovernorMulti.sol";
    ...
    IERC1155Receiver
{
    ...
    function state(
        ...
        } else if (!_quorumReached(id, proposalId) || !_voteSucceeded(proposalId)) {
    ...
    function propose(
        ...
        uint256 proposerVotes = getVotes(proposer, id, clock() - 1);
        ...
        return _propose(id, targets, values, calldatas, description, proposer);
    }
    ...
    function cancel(
        ...
        return _cancel(id, targets, values, calldatas, descriptionHash);
    }
    ...
    function getVotes(
        ...
        return _getVotes(account, id, timepoint, _defaultParams());
    }
    ...
    function getVotesWithParams(
        ...
        return _getVotes(account, id, timepoint, params);
    }
    ...
    function castVote(
        ...
        return _castVote(proposalId, voter, id, support, "");
    }
    ...
    function castVoteWithReason(
        ...
        address voter = _msgSender();
        return _castVote(proposalId, voter, id, support, reason);
    }
    ...
    function castVoteWithReasonAndParams(
        ...
        address voter = _msgSender();
        return _castVote(proposalId, voter, id, support, reason, params);
    }
    ...
    function _validateStateBitmap(
        ...
        ProposalState currentState = state(id, proposalId);
